...
-- AddForeignKey
ALTER TABLE "reviewsAndRatings" ADD CONSTRAINT "reviewsAndRatings_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
